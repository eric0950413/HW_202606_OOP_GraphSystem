...
#define cn_StudentInfo "OOP - Student Name:ªLªÃ¼Ý. ID:113550018."
#define cn_StudentInfo_f5 "Student Name:ªLªÃ¼Ý. ID:113550018."
...
bool MY_SYSTEM_APP::specialFunc(int key, int x, int y)
{
    ...
    case GLUT_KEY_F4:
        ...
        */
        break;
    case GLUT_KEY_F5:
        glutSetWindowTitle(cn_StudentInfo_f5);
